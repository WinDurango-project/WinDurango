#include "pch.h"
#include "Windows.Xbox.Multiplayer.Internal.MatchStatusChangedEventArgs.h"
#include "Windows.Xbox.Multiplayer.Internal.MatchStatusChangedEventArgs.g.cpp"
...
namespace winrt::Windows::Xbox::Multiplayer::Internal::implementation
{
    ...
    uint32_t MatchStatusChangedEventArgs::TitleId()
    {
        throw hresult_not_implemented();
    }
}
