#pragma once
#include "Windows.Xbox.Media.VideoDisplayProperties.g.h"
...
{
    struct VideoDisplayProperties : VideoDisplayPropertiesT<VideoDisplayProperties>
    {
        VideoDisplayProperties() = default;
        ...
        hstring LineupInstanceId();
        void LineupInstanceId(hstring const& value);
        hstring ChannelId();
        void ChannelId(hstring const& value);
    };
}
