#include "pch.h"
#include "Windows.Xbox.Multiplayer.Internal.PartyView.h"
#include "Windows.Xbox.Multiplayer.Internal.PartyView.g.cpp"
...
namespace winrt::Windows::Xbox::Multiplayer::Internal::implementation
{
    ...
    hstring PartyView::RawSessionDocument()
    {
        throw hresult_not_implemented();
    }
    hstring PartyView::PartyId()
    {
        throw hresult_not_implemented();
    }
    hstring PartyView::VoiceSessionId()
    {
        throw hresult_not_implemented();
    }
    uint32_t PartyView::TitleId()
    {
        throw hresult_not_implemented();
    }
}
