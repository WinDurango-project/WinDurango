#pragma once
#include "Windows.Xbox.Multiplayer.Internal.PartyRosterChangedEventArgs.g.h"
...
namespace winrt::Windows::Xbox::Multiplayer::Internal::implementation
{
    struct PartyRosterChangedEventArgs : PartyRosterChangedEventArgsT<PartyRosterChangedEventArgs>
    {
        ...
        winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Xbox::Multiplayer::Internal::TransientPartyMember> AddedMembersInternal();
        winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Xbox::Multiplayer::Internal::TransientPartyMember> RemovedMembersInternal();
        winrt::Windows::Xbox::Multiplayer::Internal::PartyView PartyViewInternal();
    };
}
